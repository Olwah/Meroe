...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nvar slideshowItems = exports.slideshowItems = {\n    0: {\n        img: 'img/Frontpage2.jpg',\n        title: 'Image 1'\n    },\n    1: {\n        img: 'img/Frontpage3.jpg',\n        title: 'Image 2'\n    },\n    2: {\n        img: 'img/Frontpage4.jpg',\n        title: 'Image 3'\n    }\n};\n\n//# sourceURL=webpack:///./src/js/models/Slideshow.js?");

/***/ }),

/***/ "./src/js/models/Spotlight.js":
/*!************************************!*\
  !*** ./src/js/models/Spotlight.js ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderSlideshowItems = exports.closeNav = exports.openNav = undefined;\nexports.showSlides = showSlides;\nexports.changeSlide = changeSlide;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar _Slideshow = __webpack_require__(/*! ../models/Slideshow */ \"./src/js/models/Slideshow.js\");\n\n/**** NAVIGATION MENU ****/\nvar openNav = exports.openNav = function openNav() {\n    _base.elements.navMenu.classList.toggle('active');\n    _base.elements.navContent.classList.toggle('active');\n    _base.elements.headerTitle.classList.toggle('active');\n    _base.elements.navMenuOpenArrow.classList.toggle('active');\n    //elements.navMenuArrowList.classList.toggle('active');\n    setTimeout(animateNavList, 100);\n};\n\nvar closeNav = exports.closeNav = function closeNav() {\n    animateNavList();\n    setTimeout(function () {\n        _base.elements.navMenuOpenArrow.classList.remove('active');\n        _base.elements.navMenu.classList.remove('active');\n        _base.elements.navContent.classList.remove('active');\n        _base.elements.headerTitle.classList.remove('active');\n        //elements.navMenuArrowList.classList.remove('active');\n    }, 300);\n};\n\nvar animateNavList = function animateNavList() {\n    var navList = document.querySelectorAll('.' + _base.elementStrings.navMenuListItem);\n    for (var i = 0; i < navList.length; i++) {\n        navList[i].classList.toggle(_base.elementStrings.navMenuListItem + '--' + (i + 1));\n    }\n};\n\n/**** SLIDESHOW ****/\n\nvar slideIndex = 0;\n\nfunction showSlides() {\n    var slides = document.getElementsByClassName('' + _base.elementStrings.headerSlides);\n    var dots = document.getElementsByClassName('' + _base.elementStrings.headerDot);\n    for (var i = 0; i < slides.length; i++) {\n        slides[i].style.display = \"none\";\n        dots[i].classList.remove('active');\n    }\n    slideIndex++;\n    if (slideIndex > slides.length) {\n        slideIndex = 1;\n    }\n    slides[slideIndex - 1].style.display = \"block\";\n    dots[slideIndex - 1].classList.add('active');\n    setTimeout(showSlides, 10000);\n};\n\nfunction changeSlide(e) {\n    if (e.target.matches('.' + _base.elementStrings.headerDot)) {\n        // Find ID of dot clicked\n        var dotID = e.target.id.split('-');\n        var dotNumber = dotID[1];\n\n        // Change all slides style to 'none'\n        var slideshowSlides = document.querySelectorAll('.' + _base.elementStrings.headerSlides);\n        slideshowSlides.forEach(function (el) {\n            el.style.display = \"none\";\n        });\n\n        // Change view to that slide\n        var currentSlide = document.getElementById('slide-' + dotNumber);\n        currentSlide.style.display = \"block\";\n\n        // Update corresponding dot\n        var dots = document.querySelectorAll('.' + _base.elementStrings.headerDot);\n        dots.forEach(function (el) {\n            el.classList.remove('active');\n        });\n        var currentDot = document.getElementById('dot-' + dotNumber);\n        currentDot.classList.add('active');\n\n        // Restart showSlides function from current position\n        // Note: showSlides function continues the loop despite clicking and changing active slide\n        var slideNumber = parseInt(dotID);\n        var _slideIndex = slideNumber;\n        return _slideIndex;\n    }\n};\n\nvar renderSlideshowItems = exports.renderSlideshowItems = function renderSlideshowItems(item) {\n    // Use 'keys' function to calculate length of an object\n    var slideshowItemsLength = Object.keys(_Slideshow.slideshowItems);\n    for (var i = 0; i < slideshowItemsLength.length; i++) {\n        createSlideshowHTML(item[i].img, item[i].title);\n        createDotHTML();\n    }\n};\n\nvar createSlideshowHTML = function createSlideshowHTML(img, title) {\n    var slidesLength = document.querySelectorAll('.' + _base.elementStrings.headerSlides).length;\n    var markup = '\\n    <div class=\"header__slideshow-slides header__slideshow-fade\" id=\"slide-' + (slidesLength + 1) + '\">\\n        <img class=\"header__slideshow-img\" src=\"' + img + '\" alt=\"' + title + '\">\\n    </div>\\n    ';\n    _base.elements.headerSlidesContainer.insertAdjacentHTML('beforeend', markup);\n};\n\nvar createDotHTML = function createDotHTML() {\n    var dotLength = document.querySelectorAll('.' + _base.elementStrings.headerDot).length;\n    var markup = '<span class=\"header__slideshow-dot\" id=\"dot-' + (dotLength + 1) + '\"></span>';\n    _base.elements.headerSlideshowDots.insertAdjacentHTML('beforeend', markup);\n};\n\n//# sourceURL=webpack:///./src/js/views/headerView.js?");

/***/ }),

/***/ "./src/js/views/spotlightView.js":
/*!***************************************!*\
  !*** ./src/js/views/spotlightView.js ***!
  \***************************************/
/*! no static exports found */
