//(function () {
    ...
    const elements = {
        ...
        carouselItems: document.querySelectorAll('.carousel__items'),
        carouselZooms: document.querySelectorAll('.carousel__zoom')
    };
    ...
    var charityItems = {
        ...
        6: {
            ...
            title: 'Gammatron',
            description: 'For Oli (2020)'
        }
    };

    const sketchbookItems = {
        0: {
            imageLeft: 'img/Sketchbook1.jpg',
            titleLeft: 'Sketchbook Page 1',
            imageRight: 'img/Sketchbook2.jpg',
            titleRight: 'Sketchbook Page 2'
        },
        1: {
            imageLeft: 'img/Sketchbook3.jpg',
            titleLeft: 'Sketchbook Page 3',
            imageRight: 'img/Sketchbook4.jpg',
            titleRight: 'Sketchbook Page 4'
        },
        2: {
            imageLeft: 'img/Sketchbook5.jpg',
            titleLeft: 'Sketchbook Page 5',
            imageRight: 'img/Sketchbook6.jpg',
            titleRight: 'Sketchbook Page 6'
        },
        3: {
            imageLeft: 'img/Sketchbook7.jpg',
            titleLeft: 'Sketchbook Page 7',
            imageRight: 'img/Sketchbook8.jpg',
    ...
    const openFocus = (e) => {
        ...
        if (e.target.matches(`.${elementStrings.spotlightZoom}, .${elementStrings.spotlightZoom} *`)) {
            ...
            */
            ...
            const pieceID = e.target.closest('div').id.split('-')[1];
            console.log(window[section][pieceID - 1]);
            ...
            // Create HTML and insert into the DOM
            createFocusHtml(`${section === 'printItems' ? 'show-client' : 'carousel'}`, img, title, client, description, portrait);
        }
    ...
    */
    ...
    const createCarouselHtml = (section, id, img, title) => {
        const markup = `
        <div class="splide__slide carousel__item ${section}__item">
            <img src="${img}" alt="${title}">
            <div class="carousel__item-info" id="${id}">
                <h3 class="carousel__item-title heading-3">${title}</h3>
                <svg class="carousel__zoom">
    ...
    const splideOptions = {
        ...
        gap: '15rem',
        classes: {
            arrow: 'splide__arrow your-class-arrow carousel__slide-arrow',
            page: 'splide__pagination__page carousel__slide-pages'
        }
    };
